...
'''
RMSE :  4.918878253914767
R2 :  0.7692102469988016
'''
...
# model = Sequential()
# model.add(Dense(500, activation='relu', input_shape=(13, ))) #(506, 13)
# model.add(Dense(200, activation='relu'))
# model.add(Dense(300, activation='relu'))
# model.add(Dense(400, activation='relu')) # strides=2 니까 2칸씩 이동한다
# model.add(Dense(200, activation='relu'))
# model.add(Dense(100)) #Dense 디폴트는  linear
...
# model.fit(x_train, y_train, epochs=300, batch_size=32, verbose=1, validation_split=0.2, callbacks=[early_Stopping])
