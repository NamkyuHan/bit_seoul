...
x1_train, x1_test, x2_train, x2_test = train_test_split(x1, x2, shuffle=True, train_size=0.7)
...
output2 = Dense(15 , name='output2')(middle1)
...
output3 = Dense(15 , name='output3')(middle1)
output3_1 = Dense(14 , name='output3_1')(output3)
output3_2 = Dense(11 , name='output3_2')(output3_1)
output3_3 = Dense(3 , name='output3_3')(output3_2)
...
# print("result : ", result)
y_1predict, y_2predict, y_3predict = model.predict([x1_test, x2_test])

from sklearn.metrics import mean_squared_error
def RMSE(y_test, y_predict):
    return np.sqrt(mean_squared_error(y_test, y_predict))
y1_rmse = RMSE(y1_test, y_1predict)
y2_rmse = RMSE(y2_test, y_2predict)
y3_rmse = RMSE(y3_test, y_3predict)
rmse_average = (y1_rmse + y2_rmse + y3_rmse) / 3

print("RMSE : ", rmse_average)

from sklearn.metrics import r2_score
r2_y1 = r2_score(y1_test, y_1predict)
r2_y2 = r2_score(y2_test, y_2predict)
r2_y3 = r2_score(y3_test, y_3predict)
